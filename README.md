...
Starting from this data, the goal is to use the Fourier transform to analyze frequencies and, through filtering techniques, reduce the curve component in the signal (for more theoretical details, see the theory folder).
